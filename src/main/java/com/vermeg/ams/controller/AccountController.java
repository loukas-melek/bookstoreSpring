...
public class AccountController {
	...
	void sendEmail(String email, boolean state) {
		...
		if (state == true) {
			...
			msg.setText("Hello,You request to join Nrm BookStore.\n Your account has been activated with success.\n " + "You can log in safely.\n"
					+ "Thank You for choosing Our BookSotre.\n \n Best Regards!\n NRM Team.\n");
		} else {
			msg.setSubject("Account Has Been desactivated");
			msg.setText("Hello, Your account has been desactivated.");
		}
